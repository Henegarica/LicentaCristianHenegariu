...
x_train, x_test, y_train, y_test = train_test_split(data_x,data_y, train_size=0.05, random_state=100, shuffle=False)
...
variable = cart.predict(x_test)

output = port(cart, language='c', template='attached')
